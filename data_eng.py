...
def remove_stop_words(txt: list):
  str1 = " " 
  list_words = []
  sentence = txt.split()
  for val in sentence:
...
def return_stem(txt):
  ...
  sentence = txt.split()
  for val in sentence:
    list_words_stemmer.append(stemmer.stem(val))

  return str2.join(list_words_stemmer)
...
def lemmat(txt: str):
  ...
  return str3.join(list_words_lemmat)